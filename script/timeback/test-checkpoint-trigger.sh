...
assert_trigger() {
  ...
  local actual
  actual=$(checkpoint_trigger "$start_edges" "$current_edges" "$elapsed" 2500 900)
...
assert_trigger none 10000 12499 899
assert_trigger edges 10000 12500 899
assert_trigger time 10000 12499 900
# Coinciding thresholds must produce one combined trigger, not two events.
assert_trigger edges+time 10000 12500 900
